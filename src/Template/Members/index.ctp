 ...
 * @var \Cake\Datasource\EntityInterface[]|\Cake\Collection\CollectionInterface $members
 */
?>
    ...
    <table cellpadding="0" cellspacing="0">
        <thead>
            <tr>
                ...
                <th scope="col"><?= $this->Paginator->sort('idcode') ?></th>
                <th scope="col"><?= $this->Paginator->sort('name') ?></th>
                <th scope="col"><?= $this->Paginator->sort('use_mode') ?></th>
